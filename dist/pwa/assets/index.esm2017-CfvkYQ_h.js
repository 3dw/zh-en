import{L as Ci,g as _e,z as f,A as Ft,D as Wt,a as Ei,B as Ii,b as Ti,G as wi,_ as Si,C as Ni,r as mn,H as N,I as Ut,J as Y,K as Ri,M as bi,N as ki,O as he,P as Qe,Q as ot,R as Oe,q as xi,T as es,U as Pi,V as Ai,y as yn,k as ts,l as Di,w as Mi,W as Oi,S as Li,X as Fi}from"./index.esm2017-DnFfU7Vi.js";var vn={};const Cn="@firebase/database",En="1.0.11";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const al=/[\[\].#$\/\u0000-\u001F\u007F]/,cl=/[\[\].#$\u0000-\u001F\u007F]/,Tt=10*1024*1024,li=function(n){return typeof n=="string"&&n.length!==0&&!al.test(n)},ai=function(n){return typeof n=="string"&&n.length!==0&&!cl.test(n)},hl=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),ai(n)},ul=function(n,e,t,s){un(Ft(n,"value"),e,t)},un=function(n,e,t){const s=t instanceof I?new br(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+J(s));if(typeof e=="function")throw new Error(n+"contains a function "+J(s)+" with contents = "+e.toString());if(rs(e))throw new Error(n+"contains "+e.toString()+" "+J(s));if(typeof e=="string"&&e.length>Tt/3&&ot(e)>Tt)throw new Error(n+"contains a string greater than "+Tt+" utf8 bytes "+J(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(L(e,(o,l)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!li(o)))throw new Error(n+" contains an invalid key ("+o+") "+J(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);kr(s,o),un(n,l,s),xr(s)}),i&&r)throw new Error(n+' contains ".value" child '+J(s)+" in addition to actual children.")}},ci=function(n,e,t,s){if(!ai(t))throw new Error(Ft(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},dl=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),ci(n,e,t)},fl=function(n,e){if(m(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},_l=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!li(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!hl(t))throw new Error(Ft(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
