...
export const features: Feature[] = [
  ...
  },
  {
    id: 'game1',
    title: '大寫字母發音選字',
    description: '聽發音，從四個選項中選出正確的大寫英文字母，練習字母辨識與聆聽能力，答對升級。',
    keywords: ['字母', '大寫', '發音', '聆聽', '選擇題', '遊戲', 'ABC'],
    route: '/game1',
    icon: 'text_fields',
    category: '字',
  },
  {
    id: 'game2',
    title: '小寫字母發音選字',
    description: '聽發音，從四個選項中選出正確的小寫英文字母，練習字母辨識與聆聽能力，答對升級。',
    keywords: ['字母', '小寫', '發音', '聆聽', '選擇題', '遊戲', 'abc'],
    route: '/game2',
    icon: 'title',
    category: '字',
  },
  ...
  },
  {
    ...
    featured: true,
    description:
      '使用本機儲存的圖片字卡產生 4 選 1 小測驗，測試您的英文理解能力，連續答對還能獲得額外獎勵！',
    keywords: ['測驗', '圖片', '字卡', '選擇題', '發音', '獎勵', '連續答對', '學習'],
    route: '/gallery',
    icon: 'collections',
    category: '句',
  },
