...
export const wordPairs: WordPair[] = [
  ...
  // ===== 字組分類單字（選「全部」時依分數難度篩選；選特定主題時整組隨機出題，見 issue #128） =====

  // 情緒 (Emotions) — 初階 (0-3000分)
  ...
  // 主格代名詞 (Subject pronouns) — 初階 (0-2000分)
  ...
  // 所有格代名詞 (Possessive adjectives) — 初階 (0-2000分)
  ...
  // 受格代名詞 (Object pronouns)；"we" 的受格為 "us"，已修正 — 初階 (0-2000分)
  ...
  // MTG 魔法風雲會 (Magic: The Gathering) — 初階 (0-3000分)
